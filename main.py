...
enemy = Enemy("cyborg.png",600,300,5)
enemy2 = Enemy("cyborg.png",600,100,5)
enemy3 = Enemy("cyborg.png",600,170,5)
pacman= GameSprite("pac-1.png",600,420,5)
w1=Wall(255,0,0,200,300,300,10)
w2=Wall(255,0,0,200,300,10,200)
...
while run:
    ...
    if not finish:
        ...
        if sprite.collide_rect(hero,enemy) or sprite.collide_rect(hero,enemy) or sprite.spritecollide(hero,walls,False):
            finish=True
